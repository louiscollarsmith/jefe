...
// snapshot. A mature store (hundreds of active beliefs) would otherwise blow
// past the provider's configured maxInputTokens. Beliefs beyond this cap are
// dropped by prioritisation (see selectPrioritizedCandidates), never by silent
// truncation.
export const MAX_INSIGHT_BELIEFS = 32;
