...
export const DETERMINISTIC_BELIEF_REGISTRY = [
  ...
  },
  {
    ...
    "derivationVersion": "v1",
    "window": "all_stored_history",
    "calculation": "median days between consecutive orders from the same customer, bucketed by rhythm at 14/35/75 days (fortnight/month/quarter; cuts placed where 203 real merchants actually differ, p20=27 p80=69); one_off when almost nobody reorders",
