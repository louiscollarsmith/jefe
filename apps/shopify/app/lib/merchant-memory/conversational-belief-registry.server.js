...
const REGISTRY = {
  ...
  "preferences.optimisation_priority": {
    ...
    valueType: CONVERSATIONAL_VALUE_TYPES.enum,
    allowedValues: ["growth", "profit", "cash_flow", "retention", "revenue", "slow_inventory", "jefe_read_first"],
    merchantCreatable: true,
    merchantCorrectable: true,
    confirmable: true,
    kind: "preference",
    merchantObsoletable: true,
    guidance: "Map profit, growth, cash flow, retention, revenue, slow inventory or an explicit Jefe-first-read priority.",
  },
