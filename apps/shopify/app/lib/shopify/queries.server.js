...
// Bootstrap (a fast/limited onboarding data path distinct from full backfill) was removed —
// see docs/ops/remove-bootstrap-full-onboarding/. The queries that only it used
// (BOOTSTRAP_RECENT_ORDERS_QUERY, BOOTSTRAP_ORDER_LINE_ITEMS_QUERY, BOOTSTRAP_ACTIVE_PRODUCTS_QUERY,
// BOOTSTRAP_PRODUCT_VARIANTS_QUERY, BOOTSTRAP_INVENTORY_LEVELS_QUERY) were removed with it. Full
// backfill's own order/product/inventory queries above are the only ingestion path now.
